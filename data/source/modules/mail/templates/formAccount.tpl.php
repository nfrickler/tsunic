...
<script type="text/javascript">
	...
	$$$formAccount__allInputs[1] = new Array('$$$formAccount__description',
												'<?php $this->set('{FORMACCOUNT__PRESET_DESCRIPTION}'); ?>',
												'<?php $this->set('{FORMACCOUNT__HELP_DESCRIPTION}'); ?>');
	$$$formAccount__allInputs[2] = new Array('$$$formAccount__email',
												'<?php $this->set('{FORMACCOUNT__PRESET_EMAIL}'); ?>',
												'<?php $this->set('{FORMACCOUNT__HELP_EMAIL}'); ?>');
	$$$formAccount__allInputs[3] = new Array('$$$formAccount__password',
												'*******',
												'<?php $this->set('{FORMACCOUNT__HELP_PASSWORD}'); ?>');
	$$$formAccount__allInputs[4] = new Array('$$$formAccount__host',
												'<?php $this->set('{FORMACCOUNT__PRESET_HOST}'); ?>',
												'<?php $this->set('{FORMACCOUNT__HELP_HOST}'); ?>');
	$$$formAccount__allInputs[5] = new Array('$$$formAccount__port',
												'<?php $this->set('{FORMACCOUNT__PRESET_PORT}'); ?>',
												'<?php $this->set('{FORMACCOUNT__HELP_PORT}'); ?>');
	$$$formAccount__allInputs[6] = new Array('$$$formAccount__user',
												'<?php $this->set('{FORMACCOUNT__PRESET_USER}'); ?>',
												'<?php $this->set('{FORMACCOUNT__HELP_USER}'); ?>');
	$$$formAccount__allInputs[7] = new Array('$$$formAccount__protocol',
												false,
												'<?php $this->set('{FORMACCOUNT__HELP_PROTOCOL}'); ?>');
	$$$formAccount__allInputs[8] = new Array('$$$formAccount__auth',
												false,
												'<?php $this->set('{FORMACCOUNT__HELP_AUTH}'); ?>');
	$$$formAccount__allInputs[9] = new Array('$$$formAccount__connsecurity',
												false,
