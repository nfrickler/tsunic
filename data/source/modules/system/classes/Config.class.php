...
class $$$Config {
	...
	/* get config-data
	 * @param string/bool $name: name of config-data (true will return all config-data)
	 * 
	 * @return OBJECT
	 */
	...
	/* get setting
	 * @param string $module: module of setting
	 * @param string/bool $name: name of setting (true will return all settings of this module)
	 * 
	 * @return mix
	 */
	 ...
	 * @param string $module: module of setting
	 * @param string/bool $name: name of setting
	 * @param string/int/bool $value: value of setting
	 * +@param string $description: description of setting
	 * +@param bool $secureSetting: secureSetting-status	 	 
	 * 
	 * @return OBJECT
	 */
	public function set ($module, $name, $value, $description = false, $secureSetting = false) {
		...
		if (!$old_value) {
			...
			// get secureSetting
			$sql_secureSetting = ($secureSetting === true) ? "secureSetting = '1'," : "secureSetting = '0',";
			// get sql_description
			$sql_description = (empty($sql_description)) ? "" : "description = '".mysql_real_escape_string($description)."',";
			// insert as new setting
	...
	/* get root-path
	 * +@param bool $data_root: get data-rootpath instead of "normal" root
	 * 
	 * @return string
	 */
