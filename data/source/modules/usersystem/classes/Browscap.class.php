<!-- p | browscap-project: https://github.com/garetjax/phpbrowscap -->
<?php
/** header *********************************************************************
 * project:			TSunic 4.1.1 | usersystem 1.1
 * file:			classes/Browscap.class.php
...
class $$$Browscap
{
	 ...
	 * @var string
	 */
	public $cacheFilename	= 'system_users__browscap.php';
	/**
	 * Where to store the downloaded ini file.
	 *
	 * @var string
	 */
	public $iniFilename		= 'system_users__browscap.ini';
	/**
